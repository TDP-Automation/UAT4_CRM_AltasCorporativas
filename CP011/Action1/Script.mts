...
'	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaEdit("TextFieldNative$1").Set "6%%%%%%%%"
	...
	wait 4
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Select "#0;Móvil;Datos;Paquete de Datos;Full Internet 2GB"
	wait 10
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").Click
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"Paquete.png", True
	imagenToWord "Paquete de full internet 2gb", RutaEvidencias() &"Paquete.png"
	wait 10
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Validar").Click
	wait 10
...
Sub Financiamiento()
	...
	Dim fac
	fac=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("Nombre a Facturar BAR").GetROProperty("text")
	While fac=""
		wait 1
		fac=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("Nombre a Facturar BAR").GetROProperty("text")
	Wend
