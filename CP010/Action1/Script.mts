...
'	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaEdit("TextFieldNative$1").Set "6%%%%%%%%"
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Validar").Click
	wait 10
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Expand "#0;Móvil;Beneficio Principal;Beneficio [0-99]"
	wait 10
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTree("Subproductos disponibles").Select "#0;Móvil;Beneficio Principal;Beneficio [0-99];Promo Dscto 50% Renta pos 6 meses"
	wait 10
	Dim add
	add=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").GetROProperty("enabled")
	If add="1" Then
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Agregar").Click
		wait 10
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"Promo.png", True
	imagenToWord "Promo Dscto 50% Renta x 6 meses", RutaEvidencias() &"Promo.png"
	wait 10
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Validar").Click
	wait 10
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Siguiente >").Click
	 ...
	 Else 
	 JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"Cancelado.png", True
		imagenToWord "No está activado la selección de la promoción", RutaEvidencias() &"Cancelado.png"
	 ...
	 While 	 JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_3").Exist=False
	 	wait 1
	 Wend
	 wait 1
	 JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_3").JavaButton("Aceptar").Click
	wait 1
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Orden 1207161A").JavaEdit("TextAreaNative$1").Exist=False
		wait 1
	Wend
	DataTable("s_Resultado", dtLocalSheet) = "Fallido"
	DataTable("s_Detalle", dtLocalSheet) = "No esta habilitado la selección de la promoción"
	Reporter.ReportEvent micFail , DataTable("s_Resultado", dtLocalSheet) , DataTable("s_Detalle", dtLocalSheet)
